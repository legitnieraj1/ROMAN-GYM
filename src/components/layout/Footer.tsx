                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex gap-3 pt-2">
                            <a
                                ...
                                className="w-9 h-9 rounded border border-white/10 flex items-center justify-center hover:border-[#00AEEF]/50 hover:bg-[#00AEEF]/10 transition-all duration-300"
                            >
                                <Instagram className="w-4 h-4 text-white/50 hover:text-[#00AEEF]" />
                            </a>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            {[
                                ...
                                <li key={link.name}>
                                    <Link href={link.href} className="text-sm text-white/30 hover:text-[#00AEEF] transition-colors duration-300">
                                        {link.name}
                                    </Link>
                                </li>
                            ))}
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            <li className="flex items-start gap-3">
                                <MapPin className="w-4 h-4 text-[#00AEEF]/50 mt-0.5 flex-shrink-0" />
                                <a
                                    href="https://maps.google.com/?q=11.1551686,76.9505951"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="text-sm text-white/30 hover:text-[#00AEEF] transition-colors"
                                >
                                    No 17, Bhagat Singh Nagar, Periyanaickenpalayam, Tamil Nadu 641020
                                </a>
                            </li>
                            <li className="flex items-center gap-3">
                                <Phone className="w-4 h-4 text-[#00AEEF]/50 flex-shrink-0" />
                                <a href="tel:+918098834154" className="text-sm text-white/30 hover:text-[#00AEEF] transition-colors">
                                    080988 34154
                                </a>
                            </li>
                            <li className="flex items-center gap-3">
                                <Mail className="w-4 h-4 text-[#00AEEF]/50 flex-shrink-0" />
                                <a href="mailto:mfppnproman@gmail.com" className="text-sm text-white/30 hover:text-[#00AEEF] transition-colors">
                                    mfppnproman@gmail.com
                                </a>
                            </li>
                            <li className="flex items-start gap-3">
                                <Clock className="w-4 h-4 text-[#00AEEF]/50 mt-0.5 flex-shrink-0" />
                                <div className="text-sm text-white/30">
                                    <p>Mon - Sat: 5 AM - 11 AM, 5 PM - 9 PM</p>
                                    <p className="text-[#00AEEF]/40">Sunday: Holiday</p>
                                </div>
                            </li>
                        </ul>
                    </div>
